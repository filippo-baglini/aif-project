...
class GoNextToSubgoal(Subgoal):
    ...
    def __call__(self):
        ...
        print(f"targettttttttttttttttttttttttttt: {self.target}")
        print(f"targetttttt POSSSSSSSSSSSSSS: {self.target_pos}")
        print(f"carrying obj {self.planner.carrying_object}")
        ...
        if self.reason == "Open" and self.planner.vis_obs[self.target_pos][2] == 2:
            if self.planner.carrying_object is not None:
                print(self.planner.carrying_object[1],self.planner.vis_obs[self.target_pos][1],self.planner.carrying_object[0])
                
                if  self.planner.carrying_object[1]==self.planner.vis_obs[self.target_pos][1] and self.planner.carrying_object[0]==5:
                    print("entra")
